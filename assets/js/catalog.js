...
const PRESETS = {
  ...
  'tutorial': {
    ...
    modules: ['students','staff','attendance','results','idcards','certificates','flyer','cbt','report-cards','analytics','admin-data','approvals','timetable-generator','checkin','diary','surveys','menu','settings','fees','messages','gallery','eresources','directory','broadcast','voting'],
...
const MODULES = [
  ...
  { id:'hr',           name:'HR & Payroll',            group:'Enterprise', desc:'Salary, allowances, deductions, auto net-pay, status workflow.', free:true, enterprise:true },
